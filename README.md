...
This repository provides a Python implementation of an LLM-based recommendation system using the LangChain pipeline. While the current pipeline is designed to recommend contents, it can be easily extended to other domains such as books.
